class Order < ApplicationRecord
  ...
  validates :total_moeny, presence: true
  validates :amount, presence: true
  validates :order_no, uniquencess: true
  ...
  def self.create_order_form_sopping_carts! user, address, *shopping_carts
    ...
    transaction do 
      ...
      shopping_carts.each do |shopping_cart|
        user.orders.create!(
          ...
          total_moeny: shopping_cart.amount * shopping_cart.product.price 
        )
      end
